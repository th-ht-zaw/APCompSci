//Bob: Thet Htay Zaw, Jerry Ye, Kathleen Wong
//APCS2 pd2
 ...
 *  We first checked if the hero was at the exit, out of bounds,or not on a
 valid path.If neither of these cases were happening, we would place a '.' at the
 hero's present location and then we would use recursion in the next adjacent
 locations.
***/
...
public class Maze
{
	...
	try {
	    ...
	    //the Tim Diep way:
	    Random r = new Random();
	    int startX = r.nextInt( 12 );
	    int startY = r.nextInt( 8 );
